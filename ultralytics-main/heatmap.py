...
def get_params():
    params = {
        'weight': 'E:\\SYQ\\yolov8-recurrent\\ultralytics-main\\runs\\detect\\train213\\weights\\best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': 'E:\\SYQ\\yolov8-recurrent\\ultralytics-main\\runs\\detect\\train261\\weights\\best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': 'E:\\SYQ\\yolov8-recurrent\\ultralytics-main\\runs\\detect\\train195\\weights\\best.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'GradCAM',
...
if __name__ == '__main__':
    ...
    # model(r'E:\\SYQ\\yolov8\\data\\images\\test\\patches_237.jpg', 'result')
    # model(r'E:\\SYQ\\yolov8\\data\\images\\test\\inclusion_170.jpg', 'result')
    model(r'E:\\SYQ\\yolov8\\data\\images\\test\\rolled-in_scale_232.jpg', 'result')
